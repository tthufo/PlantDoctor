...
export default class confirm extends Component {
  ...
  async didGetOTP() {
    ...
    try {
      ...
      Toast.show('Gửi lại mã OTP thành công.')
    } catch (e) {
      console.log(e);
      this.setState({ loading: false })
    }
  ...
  render() {
    ...
    return (
      <Container>
        <Header navigation={navigation} title={'Mã OTP'} />
        ...
        >
          ...
          >
            ...
            <Text style={{ margin: 15, fontWeight: 'normal', fontSize: 15 }}>
              {`Mật khẩu đã được gửi về số ${phoneNumber}, mời bạn thử lại`}
            </Text>
            <Input
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'center' }}>
              <TouchableOpacity testID="register_button" style={styles.btn_register} onPress={() => this.props.navigation.popToTop()}>
